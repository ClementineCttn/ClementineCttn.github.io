...
Initial results of the project were published in [@cottineau2024SLRIneq], [@san_millan_economic_2025], [@sanmillan2025wealth] and [@cottineau2025economic].
...
To operationalise this idea, I review existing knowledge and relevant models [@cottineau2024unforeseen] [@sarkar2024spatial] [@cottineau2024SLRIneq], combine them into modular infrastructure of agent-based modelling [@cottineau2015modular] [@cottineau2025agent], and use empirical microdata to test hypotheses [@cottineau2020nested] [@askenazy2024geography] [@janssen2024spatial] [@janssen2026residential].
