...
To operationalise this idea, I review existing knowledge and relevant models [@cottineau2024unforeseen] [@sarkar2024spatial], combine them into modular infrastructure of agent-based modelling [@cottineau2015modular], and use empirical microdata to test hypotheses [@cottineau2020nested] [@askenazy2024geography] [@janssen2024spatial].
